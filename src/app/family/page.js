    ...
    return (
        ...
        >
            ...
            <div className="text-center pt-10">
                ...
                <p className="text-[1.2rem] italic font-sans text-[#b68f6c] -mt-1">Family Photography</p>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        >
                            ...
                            <ul className="space-y-2 text-sm text-gray-600 list-disc list-inside text-left font-sans">
                                ...
                                <li>Up to <strong>6</strong> immediate family members</li>
                            ...
                            <div className="mt-6 text-center">
                                ...
                                <a
                                    href="https://book.usesession.com/t/xc7JgxwF65"
                                    target="_blank"
